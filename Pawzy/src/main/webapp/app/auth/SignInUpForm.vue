<template>
  <div>
    ...
    <!--
      Usaremos una ref para el contenedor principal.
      "container" es el que se anima con la clase 'right-panel-active'
    -->
...
<style scoped>
/*
 Basado en tu código CSS original, convertimos todo a "scoped"
 y conservamos la misma estructura
*/
@import url('https://fonts.googleapis.com/css?family=Montserrat:400,800');

/* Reset y estilos de cuerpo */
* {
